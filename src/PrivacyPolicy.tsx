  ...
  return (
    <>
      <SEO 
        ...
        type="website"
        tags={['Privacy', 'Data Protection', 'GDPR', 'Legal']}
      />
        ...
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 text-gray-800 dark:text-gray-100">
            ...
            <div className="space-y-6 text-base leading-relaxed">
              ...
              <p>We are required by law, regulation, or securities reasons to ask for certain personal information in order to provide our Services to you. CodByt makes commercially reasonable best efforts to maintain the confidentiality, integrity, and security of our clients' personal information.</p>
              ...
              <p>Keeping client information secure, and using it only as our Users want us to, are matters of principle for all of us at CodByt. With this in mind, here is our commitment to each and every User:</p>
              <ul className="list-disc ml-6">
              ...
              <p>CodByt will also gather the names and email addresses of users who contact us through the Site with questions about our company or lending platform. We collect this information for the sole purpose of responding to such inquiries and do not store the contact information unless requested to do so, as in the case of job applicants who submit resumes.</p>
              <p>Any data including, but not limited to, your name, address, telephone number, email address, and biometric information submitted to CodByt during the identity verification process is handled securely by our third-party, specialist identity verification provider. CodByt retains an ID and status of the process for our information and does NOT store, or use, any of the personally identifiable information (PII) submitted as part of that process.</p>
