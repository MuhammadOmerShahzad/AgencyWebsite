      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transition-transform duration-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Our <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent dark:from-blue-400 dark:to-purple-400">Portfolio</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10 mb-16 sm:mb-24">
          {projects.map((project, index) => (
            <div 
              key={index}
              className={`group bg-blue-50 dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-blue-500/10 transition-transform duration-200 overflow-hidden hover:-translate-y-2 hover:scale-105 cursor-pointer border border-blue-100 dark:border-gray-800`}
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 flex space-x-2 opacity-0 group-hover:opacity-100 transition-all duration-200 delay-100">
                  <button className="bg-white/20 dark:bg-gray-800/40 backdrop-blur-sm p-2 rounded-lg hover:bg-white/30 dark:hover:bg-gray-700/60 hover:scale-110 transition-all duration-200">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="bg-blue-100 text-blue-800 dark:bg-gray-800 dark:text-blue-300 px-3 py-1 rounded-full text-sm font-medium group-hover:bg-purple-100 dark:group-hover:bg-purple-900 group-hover:text-purple-800 dark:group-hover:text-purple-300 transition-colors duration-200">
                    {project.category}
                  </span>
                </div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">{project.title}</h3>
                ...
                <div className="mb-4">
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, techIndex) => (
                      <span 
                        key={techIndex} 
                        className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 px-2 py-1 rounded text-sm group-hover:bg-blue-50 dark:group-hover:bg-blue-900 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors duration-200"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <ul className="space-y-1">
                    {project.results.map((result, resultIndex) => (
                      <li key={resultIndex} className="flex items-center text-sm text-gray-600 dark:text-gray-300 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-200">
                        <div className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2 group-hover:bg-blue-500 group-hover:scale-125 transition-all duration-200"></div>
                        {result}
                      </li>
                    ))}
                  </ul>
        ...
        <div className={`text-center transition-transform duration-300 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 rounded-2xl p-8 hover:shadow-lg hover:-translate-y-1 transition-all duration-500 group">
            ...
            <button className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-800 dark:to-purple-800 text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg hover:-translate-y-1 transition-all duration-300 hover:scale-105 relative overflow-hidden group/cta">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-700 to-purple-700 dark:from-blue-900 dark:to-purple-900 opacity-0 group-hover/cta:opacity-100 transition-opacity duration-300"></div>
