          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300 dark:text-gray-400 hover:text-blue-400 dark:hover:text-blue-300 transition-colors duration-300 cursor-pointer">hello@codeblend.com</p>
                  <p className="text-gray-300 dark:text-gray-400 hover:text-blue-400 dark:hover:text-blue-300 transition-colors duration-300 cursor-pointer">support@codeblend.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
